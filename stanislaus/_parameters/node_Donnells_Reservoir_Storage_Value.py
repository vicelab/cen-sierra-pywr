...
class node_Donnells_Reservoir_Storage_Value(WaterLPParameter):
    ...
    def _value(self, timestep, scenario_index):
        ...
        return leading_multiplier * math.exp(multiplier * (storage_value_numerator / self.model.parameters["node/Donnells Reservoir/Elevation"].value(timestep, scenario_index)))
