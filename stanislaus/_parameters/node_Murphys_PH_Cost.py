...
class node_Murphys_PH_Cost_1(WaterLPParameter):
    """"""
    ...
    def _value(self, timestep, scenario_index):
        ...
        minVal = self.model.parameters["node/Murphys PH/Demand Constant"].value(timestep, scenario_index) * (
...
class node_Murphys_PH_Cost_2(WaterLPParameter):
    """"""
...
class node_Murphys_PH_Cost_3(WaterLPParameter):
    """"""
...
class node_Murphys_PH_Cost_4(WaterLPParameter):
    """"""
...
node_Murphys_PH_Cost_1.register()
node_Murphys_PH_Cost_2.register()
node_Murphys_PH_Cost_3.register()
node_Murphys_PH_Cost_4.register()

print(" [*] node_Murphys_PH_Cost successfully registered")
