...
class New_Spicer_Meadow_Reservoir_Storage_Value(WaterLPParameter):
...
New_Spicer_Meadow_Reservoir_Storage_Value.register()
print(" [*] New_Spicer_Meadow_Reservoir_Storage_Value successfully registered")
