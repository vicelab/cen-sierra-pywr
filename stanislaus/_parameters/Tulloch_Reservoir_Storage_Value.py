...
class Tulloch_Reservoir_Storage_Value(WaterLPParameter):
...
Tulloch_Reservoir_Storage_Value.register()
print(" [*] Tulloch_Reservoir_Storage_Value successfully registered")
