...
class node_South_San_Joaquin_Irrigation_District_Demand(WaterLPParameter):
...
node_South_San_Joaquin_Irrigation_District_Demand.register()
print(" [*] node_South_San_Joaquin_Irrigation_District_Demand successfully registered")
