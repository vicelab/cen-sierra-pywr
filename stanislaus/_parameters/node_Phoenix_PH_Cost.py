...
class node_Phoenix_PH_Cost_1(WaterLPParameter):
    """"""
    ...
    def _value(self, timestep, scenario_index):
        ...
        minVal = self.model.parameters["node/Phoenix PH/Demand Constant"].value(timestep, scenario_index) * (
...
class node_Phoenix_PH_Cost_2(WaterLPParameter):
    """"""
...
class node_Phoenix_PH_Cost_3(WaterLPParameter):
    """"""
...
class node_Phoenix_PH_Cost_4(WaterLPParameter):
    """"""
...
node_Phoenix_PH_Cost_1.register()
node_Phoenix_PH_Cost_2.register()
node_Phoenix_PH_Cost_3.register()
node_Phoenix_PH_Cost_4.register()

print(" [*] node_Phoenix_PH_Cost successfully registered")
