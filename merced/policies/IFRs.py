...
class Requirement_Merced_R_below_Crocker_Huffman_Dam(WaterLPParameter):
    """
    ...
    def value(self, timestep, scenario_index):
        ...
        return requirement_cms * 0.0864  # convert to mcm
...
Requirement_Merced_R_below_Crocker_Huffman_Dam.register()
