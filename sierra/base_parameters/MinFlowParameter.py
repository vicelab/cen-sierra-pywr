    ...
    def before(self):
        ...
        if self.include_functional_flows:
            ...
            if timestep.month == 10 and timestep.day == 1:
                ...
                wyt = sum([1 for q in terciles if fnf_annual[wy] >= q]) #the Tuolumne might require this instead: wyt = sum([1 for q in terciles if fnf_annual[datetime.strptime(str(wy), '%Y')] >= q])
