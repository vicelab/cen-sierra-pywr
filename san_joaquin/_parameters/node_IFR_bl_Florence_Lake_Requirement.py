...
class node_IFR_bl_Florence_Lake_Requirement(WaterLPParameter):
    """"""

    def _value(self, timestep, scenario_index):
        
        management = 'BAU'
        path = "Management/{mgt}/IFRs/IFRblFloranceLake.csv".format(mgt=management)
...
node_IFR_bl_Florence_Lake_Requirement.register()
print(" [*] node_IFR_bl_Florence_Lake_Requirement successfully registered")
