...
class node_IFR_bl_Tunnel_7_Div_Requirement(WaterLPParameter):
    """"""

    def _value(self, timestep, scenario_index):
        
        management = 'BAU'
        path = "Management/{mgt}/IFRs/IFRblTunnel7Div.csv".format(mgt=management)
...
node_IFR_bl_Tunnel_7_Div_Requirement.register()
print(" [*] node_IFR_bl_Tunnel_7_Div_Requirement successfully registered")
