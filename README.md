...
* Stanislaus w/ planning, debug mode
  * `python main.py -b stanislaus -p -d -n "planning method"`
...
* Stanislaus w/o planning, w/ ramp rate
  * `python main.py -b stanislaus -n "no planning"`
* Stanislaus w/ planning, w/ ramp rate
  * `python main.py -b stanislaus -p -n "planning"`
* Stanislaus w/ planning, w/o ramp rate
  ...
  * `python main.py -b stanislaus -p -n "planning - no rr"`

### Upper San Joaquin basin

* Upper San Joaquin w/o planning
  * `python main.py -b upper_san_joaquin -n "no planning"`
* Upper San Joaquin w/ planning
  * `python main.py -b upper_san_joaquin -p -n "planning"`

## 5. Generate figures

Figures can be generated by running each of three Python scripts, found in `./analyses/manuscript figures`. From within that folder, run each desired script to produce the corresponding figures. Figures will be labeled and output to the same folder.
